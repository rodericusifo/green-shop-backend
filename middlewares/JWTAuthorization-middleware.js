...
var JWTAuthorization = /** @class */ (function () {
    function JWTAuthorization() {
    }
    JWTAuthorization.verifyAccessToken = function (req, _res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    decoded = jsonwebtoken_1.default.verify(req.header('Authorization').replace('Bearer ', ''), process.env.SECRET_KEY);
    ...
    JWTAuthorization.authorization = function (req, _res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var foundUser, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, User_model_1.UserModel.findOne({ _id: req.userTokenID })];
                    case 1:
                        foundUser = _a.sent();
